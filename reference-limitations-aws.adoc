...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha.html["Scopri come funziona lo storage in una coppia Cloud Volumes ONTAP ha eseguita in AWS"^].



== Limitazioni dell'ambiente AWS C2S

https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Visualizza le limitazioni per Cloud Volumes ONTAP in AWS C2S"^].
